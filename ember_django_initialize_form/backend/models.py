...
class Status(models.Model):
    '''
    Definition of Status model for retrieving create_cluster
    ...
    cpu_p = IntegerArrayField()  # ArrayField
    mem_p = IntegerArrayField()  # ArrayField
    disk_p = IntegerArrayField()  # ArrayField
    disk_template = TextArrayField()  # ArrayField
    os_p = TextArrayField()  # ArrayField

...
from backend.get_flavors_quotas import updateStatus
from backend.models import UserInfo
from backend.serializers import OkeanosTokenSerializer, UserInfoSerializer, StatusSerializer
...
class StatusView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        '''
        Return a serialized Status model with information retrieved by

...
class OrkaImage(object):
    ...
    def create(self):
        ...
        subprocess.call("ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@{0} 'export LC_ALL=en_US.UTF-8;apt-get install -y python;'".format(self.server_ip),shell=True)
        self.create_ansible_hosts()

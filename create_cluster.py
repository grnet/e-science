...
class HadoopCluster(object):
    ...
    def check_clustersize_quotas(self):
        ...
        limit_vm = dict_quotas[self.uuid]['cyclades.vm']['limit']
        usage_vm = dict_quotas[self.uuid]['cyclades.vm']['usage']
        pending_vm = dict_quotas[self.uuid]['cyclades.vm']['pending']
    ...
    def check_network_quotas(self):
        dict_quotas = self.auth.get_quotas()
        limit_net = dict_quotas[self.uuid]['cyclades.network.private']['limit']
        usage_net = dict_quotas[self.uuid]['cyclades.network.private']['usage']
        pending_net = dict_quotas[self.uuid]['cyclades.network.private']['pending']
    ...
    def check_ip_quotas(self):
        ...
        limit_ips = dict_quotas[self.uuid]['cyclades.floating_ip']['limit']
        usage_ips = dict_quotas[self.uuid]['cyclades.floating_ip']['usage']
        pending_ips = dict_quotas[self.uuid]['cyclades.floating_ip']['pending']
    ...
    def check_cpu_valid(self):
        dict_quotas = self.auth.get_quotas()
        limit_cpu = dict_quotas[self.uuid]['cyclades.cpu']['limit']
        usage_cpu = dict_quotas[self.uuid]['cyclades.cpu']['usage']
        pending_cpu = dict_quotas[self.uuid]['cyclades.cpu']['pending']
    ...
    def check_ram_valid(self):
        dict_quotas = self.auth.get_quotas()
        limit_ram = dict_quotas[self.uuid]['cyclades.ram']['limit']
        usage_ram = dict_quotas[self.uuid]['cyclades.ram']['usage']
        pending_ram = dict_quotas[self.uuid]['cyclades.ram']['pending']
    ...
    def check_disk_valid(self):
        dict_quotas = self.auth.get_quotas()
        limit_cd = dict_quotas[self.uuid]['cyclades.disk']['limit']
        usage_cd = dict_quotas[self.uuid]['cyclades.disk']['usage']
        pending_cd = dict_quotas[self.uuid]['cyclades.disk']['pending']

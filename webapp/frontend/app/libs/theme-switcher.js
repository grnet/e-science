...
var pinkTheme = new userThemeFunc('Rose (Flat)', 'styles/bootstrap.journal.orka.css');
...
var user_themes = [blackTheme, lightTheme, pinkTheme, readableTheme, darklyTheme, lumenTheme];

...
class YarnCluster(object):
    ...
    def create_vre_server(self):
        ...
        try:
            server = self.cyclades.create_server(vre_server_name, flavor_id, image_id, personality=personality('', pub_keys_path, 'scripts/{0}'.format(self.opts['os_choice'])), project_id=self.project_id)

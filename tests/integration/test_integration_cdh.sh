...
testClusterCreate(){
	...
	if [ "$DO_INTEGRATION_TEST" = true ]; then
		...
		declare -a ARR_RESULT=($(orka create integration_test 2 4 4096 5 2 4096 10 standard escience.grnet.gr 2 128 --use_hadoop_image Hadoop_2\.6\.0\-Cloudera\-CDH\-5\.4\.2))

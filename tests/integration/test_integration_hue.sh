...
testClusterCreate(){
	...
	if [ "$DO_INTEGRATION_TEST" = true ]; then
		...
		( $(orka create hue_integration_test 2 4 6144 10 4 6144 10 standard escience.grnet.gr 1 128 --use_hadoop_image Hue-3.8.0 >_tmp.txt 2> /dev/null) ) & keepAlive $! " Working"

...
class YarnCluster(object):
    ...
    def create_bare_cluster(self):
        ...
        try:
            ...
            set_cluster_state(self.opts['token'], self.opts['cluster_name'], " Creating ~okeanos cluster...1/4")
        ...
        set_cluster_state(self.opts['token'], self.opts['cluster_name'], ' ~okeanos cluster created...2/4',
